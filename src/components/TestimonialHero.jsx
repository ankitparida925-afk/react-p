...
function TestimonialHero() {
  ...
  return (
    <section className="w-full flex flex-col items-center text-center pt-24 pb-24 overflow-hidden relative">
      ...
      {/* Arch Grid Section */}
      <div className="relative w-full max-w-[1300px] h-[300px] sm:h-[450px] md:h-[600px] flex justify-between sm:justify-center sm:gap-4 md:gap-6 px-2 sm:px-4 mx-auto z-10">
        {columns.map((col, idx) => (
          <div key={idx} className="relative w-[10.5%] sm:w-20 md:w-28 lg:w-32 h-full flex justify-center">
      ...
      <div className="max-w-4xl mx-auto px-4 flex flex-col items-center text-center relative z-20 -mt-16 sm:-mt-32 md:-mt-[22rem]">
        {/* Pill Badge */}
        <div className="bg-black/5 text-[#121212] text-xs font-semibold px-4 py-1.5 rounded-full mb-8">
          Testimonials
        </div>
        
        {/* Large Heading */}
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold tracking-tight mb-4 sm:mb-6 leading-[1.1]">
          <span className="text-[#121212]">Trusted by leaders</span><br />
          <span className="text-[#121212]/40">from various industries</span>
        </h2>
        
        {/* Subtext */}
        <p className="text-sm md:text-base text-[#121212]/80 font-medium max-w-lg mx-auto mb-10 leading-relaxed">
          Learn why professionals trust our solutions to complete their customer journeys.
        </p>
        
        {/* Black Button */}
        <button className="bg-[#121212] text-white px-5 py-2.5 rounded-full font-semibold text-sm hover:scale-105 transition-transform flex items-center gap-2 shadow-xl shadow-black/10">
